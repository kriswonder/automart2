  ...
  describe('/POST car', () => {
    ...
    it('should correctly return a car data if it was created successful', (done) => {
      ...
      requester.post('/api/v1/car')
        ...
        .attach('exterior', fs.readFileSync('./test/g.jpg'), './test/g.jpg')
        // .attach('interior', fs.readFileSync('./test/g.jpg'), 'g.jpg')
        // .attach('engine', fs.readFileSync('./test/g.jpg'), 'g.jpg')
        .field('data', JSON.stringify({
          manufacturer: 'bmw', model: 'stallion', price: '50000', state: 'new', bodyType: 'sedan', transnmission: 'automatic', milage: '5000', year: '2018', exteriorImg: 'car.exterior_img', interiorImg: 'car.interior_img', engineImg: 'car.engine_img',
        }))
        .end((err, res) => {
          res.body.should.have.property('status').eql(201);
          res.body.should.have.property('data');
    ...
    it('should return an error, when car lacks price or any required data', (done) => {
      requester.post('/api/v1/car')
        .set('x-access-token', token)
        .attach('exterior', fs.readFileSync('./test/g.jpg'), './test/g.jpg')
        // .attach('interior', fs.readFileSync('./test/g.png'), 'g.png')
        // .attach('engine', fs.readFileSync('./test/g.png'), 'g.png')
        .field('data', JSON.stringify({
          manufacturer: 'bmw', model: 'stallion', price: '50000', bodyType: 'sedan', transnmission: 'automatic', milage: '5000', year: '2018', exteriorImg: 'car.exterior_img', interiorImg: 'car.interior_img', engineImg: 'car.engine_img',
        }))
        .end((err, res) => {
  ...
  describe('/GET car', () => {
    ...
    it('should correctly return a car data if it was created successful', (done) => {
      ...
      requester.post('/api/v1/car')
        .set('x-access-token', token)
        .attach('exterior', fs.readFileSync('./test/g.jpg'), './test/g.jpg')
      // .attach('interior', fs.readFileSync('./test/g.jpg'), './test/g.jpg')
      // .attach('engine', fs.readFileSync('./test/g.jpg'), './test/g.jpg')
        .field('data', JSON.stringify({
          manufacturer: 'bmw', model: 'stallion', price: '50000', state: 'new', bodyType: 'sedan', transnmission: 'automatic', milage: '5000', year: '2018', exteriorImg: 'car.exterior_img', interiorImg: 'car.interior_img', engineImg: 'car.engine_img',
        }))
        .end((err, res) => {
